...
public class ProductController {
    ...
    @Operation(
            ...
            description = "Позволяет добавить один новый товар в список товаров (не на склад). Возвращает этот товар."
    )
    @PostMapping
    ...
    @Operation(
            ...
            description = "Позволяет архивировать все существующие товары (которых еще нет на складах и которые уже " +
                    ...
                    "сохраняется, но сами товары уже не смогут быть использованы в дальнейшем. Возвращает эти товары."
    )
    ...
    @Operation(
            ...
            description = "Позволяет архивировать один существующий товар (со склада или еще не поступившего ни на " +
                    ...
                    "уже не может быть использован в дальнейшем. Возвращает этот товар."
    )
    ...
    @Operation(
            ...
            description = "Позволяет удалить один существующий товар из списка товров по его ID. Не " +
                    ...
                    "в которых данный товар присутствовал. Возвращается http код."
    )
    @DeleteMapping("/{id}")
